	...
	<div class="bg_color1 border_end">
		...
		<div class="demo11 pagebody3 wid">
			...
			<ul class="tab_menu pagebody3_all">
				...
				<li class="current" onclick="goToPublicmessageList()" style="cursor:pointer">公告</li>
			...
			<div class="tab_box ">
				...
				<div class="pagebody3_news" id="xiaoxi" style="height:500px;">
					...
					<ul>
						<c:forEach var="publicmessage" items="${page.list}" varStatus="status">
							<li onclick="tell('${publicmessage.url}')"><a href="javascript:;" >${publicmessage.title}</a><span><fmt:formatDate
										value="${publicmessage.creattime}" pattern="yyyy-MM-dd HH:mm:ss" /></span></li>
						</c:forEach>
					</ul>
                 ...
                 <!-- 
                  ...
                  -->
					<ul class="page">
					    ...
					    <a href="${ctx}/index/notice.shtml?pageNo=${pageNo}&pageSize=10" style="background: #C30D23 none repeat scroll 0% 0%;color:#ffffff;">${pageNo}</a>
					     </c:when>
					   <c:otherwise>
					   <a href="${ctx}/index/notice.shtml?pageNo=${pageNo}&pageSize=10" >${pageNo}</a>
					   </c:otherwise>
					   </c:choose>
